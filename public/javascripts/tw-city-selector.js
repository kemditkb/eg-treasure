...
function setElements() {
	...
	this.elCounty.id = this.options.countyFiledName;
	this.elCounty.required = true;
	...
	this.elDistrict.id = this.options.districtFieldName;
	this.elDistrict.required = true;
